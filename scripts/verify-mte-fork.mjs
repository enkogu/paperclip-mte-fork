...
assert.equal(abi.packages.daytonaServerResolver, "/app/server/node_modules/@paperclipai/plugin-daytona");
assert.equal(abi.packages.daytonaSdk, "/app/plugins/daytona/node_modules/@daytonaio/sdk");
assert.equal(abi.packages.daytonaSdkServerResolver, "/app/server/node_modules/@daytonaio/sdk");
...
assert.match(dockerfile, /ln -s \.\.\/\.\.\/\.\.\/plugins\/daytona \/opt\/runtime\/server\/node_modules\/@paperclipai\/plugin-daytona/);
assert.match(dockerfile, /ln -s \.\.\/\.\.\/\.\.\/plugins\/daytona\/node_modules\/@daytonaio\/sdk \/opt\/runtime\/server\/node_modules\/@daytonaio\/sdk/);
